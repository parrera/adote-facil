# Refatorações de Code Smells

Este documento descreve os code smells identificados no projeto e as refatorações aplicadas.

---

## 1. Refatoração no `CreateAnimalService`
